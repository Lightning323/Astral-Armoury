...
import org.lightning323.nexus.Nexus;
import org.lightning323.nexus.blocks.angelScaffolding.ItemScaffolding;
import org.lightning323.nexus.utils.ItemStackUtil;
import org.lightning323.nexus.utils.LevelWorldUtil;


//This tag automatically adds the event without needing to register it manually
@Mod.EventBusSubscriber(modid = Nexus.MOD_ID, bus = Mod.EventBusSubscriber.Bus.FORGE)
