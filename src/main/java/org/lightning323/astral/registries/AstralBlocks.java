...
public class AstralBlocks {
    ...
    public static final DeferredBlock<Block> SCAFFOLD_FRAGILE = registerBlock("scaffold_fragile", () -> new BlockScaffolding(Block.Properties.of(), true));
    public static final DeferredBlock<Block> SCAFFOLD_RESPONSIVE = registerBlock("scaffold_responsive", () -> new BlockScaffoldingResponsive(Block.Properties.of(), false));
