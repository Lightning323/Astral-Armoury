...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("item.astral.smithing_template.infernal_upgrade.applies_to", "Shields & Tridents");
        add("item.astral.smithing_template.infernal_upgrade.ingredients", "Netherite Ingots");
        add("item.astral.smithing_template.infernal_upgrade.upgrade", "Infernal Upgrade");
        add("item.astral.smithing_template.infernal_upgrade.base_slot_description", "Add shield or trident");
        add("item.astral.smithing_template.infernal_upgrade.addition_slot_description", "Add Netherite Ingot");
